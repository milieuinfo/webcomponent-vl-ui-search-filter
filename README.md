...
## API
De [API](https://webcomponenten.omgeving.vlaanderen.be/doc/VlSearchFilter.html) bevat een overzicht van de ondersteunde attributen en een beschrijving van de beschikbare functies.
