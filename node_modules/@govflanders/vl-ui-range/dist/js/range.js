(function (global, factory) {
    ...
    _createClass(RangeSlider, [{
      ...
      value: function moveSliderTo(handleEl, value) {
        ...
        if (handleEl === this.minHandleEl) {
          ...
          handleEl.style.transform = "translateX(".concat(pos + this.thumbWidth - this.railBorderWidth + 'px', ")");
        }
  ...
  var raClass$1 = "js-".concat(vl.ns, "range"),
      raAtt = "data-".concat(vl.ns, "range"),
  ...
  function () {
    ...
    _createClass(Range, [{
      ...
      value: function dressAll() {
        var elements = document.querySelectorAll(".".concat(raClass$1, ":not([").concat(raDressedAtt, "]):not([data-vl-js-dress=\"false\"]),\n      [").concat(raAtt, "]:not([").concat(raDressedAtt, "]):not([data-vl-js-dress=\"false\"])"));
        vl.util.each(elements, function (rangeEl) {
